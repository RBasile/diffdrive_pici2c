...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch diffdrive_pici2c view_robot.launch.py
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [DiffDrivePicHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [DiffDrivePicHardware]: Got command 50.00000 for 'right_wheel_joint'!
